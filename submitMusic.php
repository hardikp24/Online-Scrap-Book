...
<table cellpadding="8">
			...
			<?php
				...
				require'connect.php';
						...
						if(isset($_POST['op1'])&&isset($_POST['artist'])&&isset($_POST['song'])&&isset($_POST['band'])&&isset($_POST['instrument'])&&isset($_POST['poll1']))
						{
						   $op1=$_POST['op1'];
						   $artist=$_POST['artist'];
						   $song=$_POST['song'];
						   ...
						   $poll=$_POST['poll1'];
						        ...
						        $query= "INSERT INTO `music` VALUES ('$op1' , '$artist' , '$song' , '$band' , '$instrument' , '$poll1')";
